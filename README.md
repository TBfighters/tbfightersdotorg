...
> Note: To update the featured action, go to ./update-action/index.js and change the code there. Then, with [node](https://nodejs.org/en) installed, run `node .` in that directory.
